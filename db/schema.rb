...
ActiveRecord::Schema.define(version: 20170712101711) do
  ...
  create_table "friends", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "proposer"
    t.integer "recipient"
    t.index ["proposer"], name: "fk_rails_38247b9c8e", using: :btree
    t.index ["recipient"], name: "fk_rails_6ac3cb8148", using: :btree
  end
